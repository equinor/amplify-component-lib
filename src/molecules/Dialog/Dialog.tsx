 ...
 * @param withContentPaddingX - Defaults to true
 * @param withContentPaddingY - Defaults to true
 * @param withBorders - Defaults to false
 * @param contentMaxHeight - Defaults to '60vh'
 * @param hideClose - Defaults to true
  ...
  (
    {
      ...
      additionalInfo = (
        <div>
          ...
          <Typography>
            When the selected group of experiences are ready to be publish,
            check the last checkbox that says &#39;Selected set of experiences
            are ready for publishing&#39;. This will notify the publisher that
            you are ready to publish them.
          </Typography>
        </div>
      ),
      ...otherProps
    ...
    return (
      ...
      >
        ...
        <DialogContent
          $withContentPaddingX={withContentPaddingX}
          $withContentPaddingY={withContentPaddingY}
          style={{
