import { Canvas, Controls, Primary } from '@storybook/blocks';
...
<Links
  ...
  edsSBUrl="https://storybook.eds.equinor.com/?path=/docs/inputs-dates-datepicker--docs"
/>
...
```
<DatePicker meta="Required" />
```

<Canvas of={ComponentStories.WithMetaText} />
