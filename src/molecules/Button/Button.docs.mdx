...
import * as ComponentStories from 'src/molecules/Button/Button.stories';
...
<Links ariaUrl="https://www.w3.org/WAI/ARIA/apg/patterns/button/" figmaUrl="https://www.figma.com/file/0bGXR2sCwMVSDNyyzu5BXrO5/UI%E2%80%94User-Interface?node-id=17394%3A47297" sourceUrl="https://github.com/equinor/design-system/tree/develop/packages/eds-core-react/src/components/Button" edsSBUrl="https://storybook.eds.equinor.com/?path=/docs/inputs-button-button--docs" />
...
```tsx
import { Button } from '@equinor/amplify-components';
...
```tsx
<Button as="a" href="/about" target="_blank" rel="noreferrer">
  About
</Button>
```
...
<ul>
  <li>
    <code>Contained</code> - being high-emphasis.
  </li>

  <li>
    <code>Outlined</code> - being medium-emphasis.
  </li>

  <li>
    <code>Ghost</code> - being low-emphasis.
  </li>
</ul>
