...
import { Primary, Canvas, Controls, Source } from '@storybook/addon-docs/blocks';
...
<Links
  ...
  edsSBUrl="https://storybook.eds.equinor.com/?path=/docs/inputs-button-button--docs"
/>
...
Use the `loading` boolean prop if you need progress indication on a button.

<Canvas of={ComponentStories.LoadingState} />
