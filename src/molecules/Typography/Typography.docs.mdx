...
import * as ComponentStories from 'src/molecules/Typography/Typography.stories';
...
<Links figmaUrl="https://www.figma.com/file/0TbIXrrObWj80Cf7KucKYFL0/Design-Tokens?node-id=2%3A4" sourceUrl="https://github.com/equinor/design-system/blob/develop/packages/eds-core-react/src/components/Typography/Typography.tsx" edsSBUrl="https://storybook.eds.equinor.com/?path=/docs/typography-typography--docs" />
...
<link
  rel="stylesheet"
  href="https://cdn.eds.equinor.com/font/equinor-regular.css"
/>
```
...
<ul>
  ...
  <li>
    with accompanying <code>italics</code>.
  </li>
</ul>
...
<ul>
  <li>
    Paragraph length is the number of characters in a line of text, this
    includes spaces.
  </li>
...
```tsx
import { Typography } from '@equinor/amplify-components';
...
<Typography as={Link} to="/about" link>
  About
</Typography>;
```
