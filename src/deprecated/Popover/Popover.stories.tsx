...
import page from 'src/deprecated/Popover/Popover.docs.mdx';
...
const meta: Meta<typeof Popover> = {
  ...
  subcomponents: {
    ...
    Title: Title as ComponentType<unknown>,
    Content: Content as ComponentType<unknown>,
    Actions: Actions as ComponentType<unknown>,
  },
  parameters: {
    docs: {
      page,
...
export const ActivateOnHover: StoryFn<PopoverProps> = () => {
  const [isOpen, setIsOpen] = useState<boolean>(false);
  const anchorRef = useRef<HTMLButtonElement>(null);
  let timer: ReturnType<typeof setTimeout> = setTimeout(() => null, 100);
