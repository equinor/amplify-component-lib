...
import { HighlightBlocks } from 'src/deprecated/Tutorial/HighlightBlocks/HighlightBlocks';
import Tutorial, { TutorialProps } from 'src/deprecated/Tutorial/Tutorial';
