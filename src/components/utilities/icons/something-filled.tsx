...
const SomethingFilled: React.FC<ISvgIconProps> = ({ size }) => (
  <svg
    width={size ? size : 48}
    height={size ? size : 48}
    viewBox="0 0 48 48"
  ...
  >
    ...
    <rect x="0.5" y="0.5" width="47" height="47" rx="7.5" stroke="#007079" strokeDasharray="4 4" />
  </svg>
);

export default SomethingFilled;
