...
export default {
  title: 'DataDisplay/ProfileAvatar',
...
export const DisabledWithImage = ProfileAvatarStory.bind({});
DisabledWithImage.args = {
  name: username,
  size: 'large',
  url: userphoto,
  disabled: true,
...
export const WithoutImage = ProfileAvatarStory.bind({});
WithoutImage.args = {
  name: username,
  size: 'large',
};

export const DisabledWithoutImage = ProfileAvatarStory.bind({});
DisabledWithoutImage.args = {
  name: username,
  size: 'large',
  disabled: true,
};
