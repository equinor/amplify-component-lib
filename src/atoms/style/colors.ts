...
export const colors = {
  ...
  dataviz: {
    primary: {
      ...
      10: 'var(--amplify_dataviz_primary_10, rgba(235, 245, 255, 1))',
      20: 'var(--amplify_dataviz_primary_20, rgba(211, 231, 253, 1))',
      30: 'var(--amplify_dataviz_primary_30, rgba(167, 206, 251, 1))',
      40: 'var(--amplify_dataviz_primary_40, rgba(133, 187, 250, 1))',
      50: 'var(--amplify_dataviz_primary_50, rgba(89, 163, 248, 1))',
      60: 'var(--amplify_dataviz_primary_60, rgba(40, 136, 246, 1))',
      70: 'var(--amplify_dataviz_primary_70, rgba(0, 107, 229, 1))',
      80: 'var(--amplify_dataviz_primary_80, rgba(0, 83, 178, 1))',
      90: 'var(--amplify_dataviz_primary_90, rgba(5, 60, 122, 1))',
    },
    darkblue: {
